...
driver.findElement(By.name("first_name")).sendKeys("Jeevan");
driver.findElement(By.name("last_name")).sendKeys("Soawane");
driver.findElement(By.name("address")).sendKeys("Kalyan");
